...
namespace Windo.Persistence.Migrations
{
    ...
    [Migration("20220408191935_status_licenca")]
    partial class status_licenca
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Windo.Persistence.Dominio.LicencaCliente", b =>
                {
                    ...
                    b.Property<int>("StatusLicencaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Windo.Persistence.Dominio.StatusLicenca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Windo.Persistence.Dominio.LicencaCliente", b =>
                {
                    ...
                    b.HasOne("Windo.Persistence.Dominio.StatusLicenca", "StatusLicencaNavigation")
                        .WithMany("Licencas")
                        .HasForeignKey("StatusLicencaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("StatusLicencaNavigation");
                });
